...
class TestProductionResilience:
    ...
    def test_memory_leak_prevention(self):
        ...
        for iteration in range(10):
            ...
            params_batch = [
                {"temp": 100 + i + iteration * 10, "conc": 1.0}
                for i in range(50)
            ]
...
class TestScalabilityValidation:
    ...
    def test_load_balancing_effectiveness(self):
        ...
        for _ in range(100):
            ...
            worker_selections[selected_worker] = worker_selections.get(selected_worker, 0) + 1
...
class TestConfigurationManagement:
    ...
    def test_security_configuration_validation(self):
        ...
        with pytest.raises(ValueError):
            validator.validate_campaign_config({"max_experiments": 2000})  # Exceeds limit
        
        # Test permissive config
        permissive_config = SecurityConfig(
            max_parameter_value=10000.0,
