...
class SampleDataGenerator:
    ...
    def generate_experiment_data(
        ...
        for i in range(n_experiments):
            ...
            base_bandgap = (
                1.4 + 0.2 * temp_factor + 0.1 * conc_factor - 0.05 * time_factor
            )
            ...
            if 1.2 <= bandgap <= 1.6:
                efficiency = 25 * (1 - abs(bandgap - 1.4) / 0.4) + np.random.normal(
                    0, 2
                )
            else:
    ...
    def generate_campaign_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "best_result": {"band_gap": 1.413, "efficiency": 27.1, "stability": 0.820},
