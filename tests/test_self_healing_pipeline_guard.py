...
class TestSelfHealingPipelineGuard:
    ...
    def test_failure_reporting(self, pipeline_guard):
        ...
        assert pipeline_guard.failures[failure_id].failure_type == FailureType.ROBOT_DISCONNECTION
...
class TestIntelligentFailoverManager:
    ...
    async def test_predictive_monitoring(self, failover_manager):
        ...
        # Start monitoring
        monitor_task = asyncio.create_task(failover_manager.start_predictive_monitoring())
...
class TestAdvancedMonitoringSystem:
    ...
    def test_sla_target_management(self, monitoring_system):
        ...
        monitoring_system.add_sla_target(
            "test_sla",
            95.0,
            ">",
            3600
...
class TestIntegration:
    ...
    async def _trigger_component_failure(self, pipeline_guard, failover_manager, component_id):
