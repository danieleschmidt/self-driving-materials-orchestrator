...
from materials_orchestrator import (
    ...
    ExperimentDatabase, RobotOrchestrator
)
...
class TestFullSystemIntegration:
    ...
    def test_error_handling_integration(self):
        ...
        from materials_orchestrator.error_handling import handle_errors, ErrorCategory, ErrorSeverity
    ...
    def test_robot_orchestration_integration(self):
        ...
        async def test_connections():
            ...
            actions = [
                {"robot": "robot_1", "action": "move", "parameters": {"x": 10, "y": 20}},
                {"robot": "robot_2", "action": "heat", "parameters": {"temperature": 150}},
                {"instrument": "xrd_1", "action": "measure", "parameters": {"sample_id": "test"}}
            ]
    ...
    def test_data_persistence_and_retrieval(self):
        ...
        high_temp_experiments = db.query_experiments(
            filter_criteria={"parameters.temperature": {"$gte": 150}},
            limit=10
        )
...
class TestPerformanceBenchmarks:
    ...
    def test_database_query_performance(self):
        ...
        filtered_results = db.query_experiments(
            filter_criteria={"parameters.temp": {"$gte": 200}},
            limit=50
        )
