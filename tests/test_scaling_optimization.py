...
class TestCachingSystem:
    ...
    def test_experiment_result_cache(self):
        ...
        parameters = {"temperature": 150.0, "concentration": 1.0}

        result = {"band_gap": 1.5, "efficiency": 20.0, "stability": 0.8}
...
class TestIntegrationScaling:
    ...
    def test_scaled_campaign_execution(self):
        ...
        campaign = lab.run_campaign(
            objective=objective, param_space=param_space, max_experiments=5
        )
