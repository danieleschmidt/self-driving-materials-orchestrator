...
class TestOptimizationPerformance:
    ...
    def large_parameter_space(self):
        ...
        return {
            f"param_{i}": (0.0, 10.0) for i in range(20)  # 20-dimensional space
        }
    ...
    def test_acquisition_function_performance(self, benchmark):
        ...
        for acq_func in acquisition_functions:
            execution_time, n_suggestions = benchmark(benchmark_acquisition_function, acq_func)
    ...
    def test_parallel_optimization(self, benchmark):
        ...
        experiments = SampleDataGenerator.generate_experiment_data(200, noise_level=0.05)
        ...
        for batch_size in [1, 5, 10, 20]:
            execution_time, n_suggestions = benchmark(run_parallel_optimization, batch_size)
    ...
    def test_convergence_speed(self, benchmark):
        ...
        strategies = [
            ...
            {"algorithm": "bayesian", "params": {"acquisition_function": "expected_improvement"}},
            {"algorithm": "bayesian", "params": {"acquisition_function": "upper_confidence_bound"}},
        ]
        ...
        for strategy in strategies:
            ...
            execution_time, best_value, n_experiments = benchmark(benchmark_convergence, strategy)
    ...
    def test_memory_usage(self, benchmark):
        ...
        for n_experiments in [100, 500, 1000]:
            memory_increase, n_suggestions = benchmark(measure_memory_usage, n_experiments)
