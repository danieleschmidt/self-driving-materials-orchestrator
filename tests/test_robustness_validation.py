...
class TestErrorHandling:
    ...
    def test_experiment_failure_recovery(self):
        ...
        with patch('materials_orchestrator.core.simulate_perovskite_experiment') as mock_exp:
            mock_exp.side_effect = [Exception("Equipment failure"), 
...
class TestPerformanceRobustness:
    ...
    def test_large_parameter_space(self):
        ...
        param_space = {
            f"param_{i}": (0, 100) for i in range(20)
        }
