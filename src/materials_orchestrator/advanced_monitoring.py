...
class MetricsCollector:
    ...
    def calculate_aggregation(self, name: str, aggregation: str, duration_seconds: int = 300) -> Optional[float]:
        ...
        for metric_name in self.metrics.keys():
            try:
                ...
                self.aggregated_metrics[metric_name] = {
                    "avg": self.calculate_aggregation(metric_name, "avg", self.aggregation_window) or 0,
                    "min": self.calculate_aggregation(metric_name, "min", self.aggregation_window) or 0,
                    "max": self.calculate_aggregation(metric_name, "max", self.aggregation_window) or 0,
                    "count": self.calculate_aggregation(metric_name, "count", self.aggregation_window) or 0,
                }
            except Exception as e:
...
class AlertManager:
    ...
    async def _evaluate_rule(self, rule_name: str, rule: Dict[str, Any]):
        ...
        recent_values = self.metrics_collector.get_metric_values(metric_name, duration_seconds)
...
class AdvancedMonitoringSystem:
    ...
    def add_sla_target(self, name: str, target_value: float, comparison: str = ">", measurement_window: int = 3600):
    ...
    def add_health_check(self, name: str, check_function: Callable, interval_seconds: int = 30):
        """Add health check."""
        ...
        return {
            ...
            "metrics": {
                ...
                "latest_values": {
                    ...
                    for name in list(self.metrics_collector.metrics.keys())[:10]  # First 10 metrics
                }
            },
