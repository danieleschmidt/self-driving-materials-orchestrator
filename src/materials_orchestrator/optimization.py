...
class AdaptiveCache:
    ...
    def put(self, key: str, value: Any, ttl: Optional[float] = None) -> None:
        ...
        with self._lock:
            ...
            entry = CacheEntry(key=key, value=value, created_at=datetime.now(), ttl=ttl)
...
class ConcurrentExecutor:
    ...
    def submit_task(self, func: Callable, *args, **kwargs) -> str:
        ...
        future = self.executor.submit(
            self._execute_with_timing, func, task_id, *args, **kwargs
        )
...
class AutoScaler:
    ...
    def get_scaling_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            scale_downs = sum(
                1 for d in recent_decisions if d["action"] == "scale_down"
            )
            ...
            return {
                ...
                "max_workers": self.max_workers,
                "avg_load": (
                    sum(self.load_history[-10:]) / len(self.load_history[-10:])
