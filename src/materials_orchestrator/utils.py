            ...
            class MockRandom:
                ...
                def rand(*args):
                    if len(args) == 0:
                        ...
                        return [[random.random() for _ in range(args[1])] 
                ...
                def normal(loc=0.0, scale=1.0, size=None):
                    ...
                    if size is None:
                        ...
                        return [[random.gauss(loc, scale) for _ in range(size[1])] 
...
def safe_numerical_operation(operation, *args, default_value=0.0):
    ...
    try:
        ...
        logger.warning(f"Numerical operation failed: {e}, returning default: {default_value}")
        return default_value

# Export availability flags and implementations
__all__ = [
    'np', 'optimize', 'stats', 'GaussianProcessRegressor', 'Matern', 'RBF', 'psutil',
    'NUMPY_AVAILABLE', 'SCIPY_AVAILABLE', 'SKLEARN_AVAILABLE', 'PYMONGO_AVAILABLE', 'PSUTIL_AVAILABLE',
    'ensure_numpy_compatible', 'safe_numerical_operation'
]