...
class CampaignRequest(BaseModel):
    ...
    planner_type: str = Field(default="bayesian", description="Optimization planner type")
...
def create_production_api() -> FastAPI:
        ...
        try:
            ...
            health_details = {
                ...
                "performance": {
                    ...
                    "resource_utilization": perf_report["execution_performance"]["resource_utilization"],
                    "average_response_time": perf_report["execution_performance"]["average_response_time"]
                },
                "security": {
    ...
    async def get_system_status():
        ...
        try:
            ...
            return {
                ...
                "optimization_recommendations": perf_report["optimization_recommendations"]
            }
    ...
    async def get_metrics():
        ...
        try:
            ...
            metrics = []
            metrics.append(f"materials_orchestrator_experiments_total {lab.total_experiments}")
            metrics.append(f"materials_orchestrator_success_rate {lab.success_rate}")
            metrics.append(f"materials_orchestrator_cache_hit_rate {perf_report['cache_performance']['hit_rate']}")
            metrics.append(f"materials_orchestrator_response_time_seconds {perf_report['execution_performance']['average_response_time']}")
            metrics.append(f"materials_orchestrator_throughput_ops_per_second {perf_report['execution_performance']['throughput']}")
